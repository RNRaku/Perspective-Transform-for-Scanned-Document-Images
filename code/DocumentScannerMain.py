...
webCamFeed = False
pathImage = "C:/Users/RNRaku/Desktop/CVproject/code/doc1.jpg"
cap = cv2.VideoCapture(0)
cap.set(10,160)
scale_factor = 0.75
heightImg = int(640 * scale_factor)
widthImg  = int(480 * scale_factor)
...
while True:
    ...
    lables = (["Original", "GrayScale", "Canny", "Contours"],["Biggest Contour", "Warp Perspective", "greyScale", "Adaptive Threshold"])
    # lables = ["Original", "Gray", "Threshold", "Contours","Biggest Contour", "Warp Perspective", "Warp Gray", "Adaptive Threshold"]
